<template>
  ...
  <div class="d-flex flex-column h-100">
    ...
    <div class="gloal-content flex-grow-1 d-flex flex-row mx-2">
      <left-side-data-control-panel></left-side-data-control-panel>
      <dispaly-content-panel></dispaly-content-panel>
    </div>
  </div>
</template>
